...
# Constants
INPUT_FILES = {
    "Merged": "results/tensorboard/ar_conditioner_train/loss/merged.csv",
    "No Args": "results/tensorboard/ar_conditioner_train/loss/no_args.csv",
    "Random Assign": "results/tensorboard/ar_conditioner_train/loss/random_assign.csv",
    "Synthetic": "results/tensorboard/ar_conditioner_train/loss/synthetic.csv",
}
PLOT_FIGSIZE = (12, 8)
